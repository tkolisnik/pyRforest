...
reticulate::virtualenv_create(envname = "pyRforest-venv", python_version = "3.9.18", packages = c("scikit-learn==1.3.2", "numpy==1.26.0", "shap==0.43.0","scikit-optimize==0.10.2", "memory_profiler==0.61.0"))
...
reticulate::conda_install(envname = "pyRforest-conda", python_version = "3.9.18",packages = c("scikit-learn==1.3.2", "numpy==1.26.0", "shap==0.43.0","scikit-optimize==0.10.2", "memory_profiler==0.61.0"))
...
<li>The <em>target_categorical</em> Optional. This column provides the outcome variable in a categorical format. The <em>target</em> column provides the outcome variable in binary format. This dataframe is primarily used to assist with mapping for SHAP and to assist the user keep track of their data. </li>
...
# If a models classes are: ['Left' 'Right'] their order represents the index (starting at 0) that should be passed to class_index
